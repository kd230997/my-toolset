  ...
  return (
    ...
    >
      <div className="basis-2/12 flex flex-row px-5 py-2 gap-4">
        <Bars className="cursor-pointer w-8 h-8 px-1 fill-primary-text-lighter" onClick={toggleMenuHandler} />
      ...
      <div className="basis-4/12 flex justify-end py-2 gap-5 px-4">
        <div className="cursor-pointer relative mt-1">
          <p className="animate-ping absolute top-[-5px] right-0 text-xs w-4 h-4 p text-center rounded-full bg-primary-red text-primary-content font-bold">1</p>
