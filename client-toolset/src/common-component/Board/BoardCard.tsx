...
export default function BoardCard(props?: BoardCardProps) {
  return (
    <div
      key={props?.id}
      className={`${props?.className} w-fit h-fit rounded-lg p-4 shadow-primary-text-lighter shadow-md hover:shadow-lg hover:shadow-primary-text-dark bg-white/75 text-primary-text-dark`}
    >
      ...
      <div className="h-1/4 flex flex-row justify-between text-sm">
        <p className="mr-3">{props?.owner}</p>
